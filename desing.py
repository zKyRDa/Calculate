...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/icons/svg-editor-image.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border: none;")
        ...
        sizePolicy2.setHeightForWidth(self.Button_acos.sizePolicy().hasHeightForWidth())
        self.Button_acos.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_cos.sizePolicy().hasHeightForWidth())
        self.Button_cos.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_scobs.sizePolicy().hasHeightForWidth())
        self.Button_scobs.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_plusminus.sizePolicy().hasHeightForWidth())
        self.Button_plusminus.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_e.sizePolicy().hasHeightForWidth())
        self.Button_e.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_asin.sizePolicy().hasHeightForWidth())
        self.Button_asin.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_lg.sizePolicy().hasHeightForWidth())
        self.Button_lg.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_1x.sizePolicy().hasHeightForWidth())
        self.Button_1x.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_Pi.sizePolicy().hasHeightForWidth())
        self.Button_Pi.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_sin.sizePolicy().hasHeightForWidth())
        self.Button_sin.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_equally.sizePolicy().hasHeightForWidth())
        self.Button_equally.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.Button_split.sizePolicy().hasHeightForWidth())
        self.Button_split.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.Button_v.sizePolicy().hasHeightForWidth())
        self.Button_v.setSizePolicy(sizePolicy2)
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/outline_keyboard_backspace_white_48dp.png", QSize(), QIcon.Normal, QIcon.Off)
        self.Button_BACKSPACE.setIcon(icon2)
        ...
        sizePolicy2.setHeightForWidth(self.Button_x1.sizePolicy().hasHeightForWidth())
        self.Button_x1.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_atan.sizePolicy().hasHeightForWidth())
        self.Button_atan.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_tan.sizePolicy().hasHeightForWidth())
        self.Button_tan.setSizePolicy(sizePolicy2)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.Button_ln.sizePolicy().hasHeightForWidth())
        self.Button_ln.setSizePolicy(sizePolicy2)
...
"}")
        ...
        self.gridLayout.addLayout(self.Layout_buttons, 2, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"111", None))
